...
export const BriefcaseIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M20.25 14.15v4.07a2.25 2.25 0 01-2.25 2.25H5.92a2.25 2.25 0 01-2.25-2.25v-4.07a2.25 2.25 0 01.92-1.75L3 12.5l.02.01a2.25 2.25 0 012.23-1.76h13.5c.91 0 1.7.54 2.06 1.33L21 12.5l-1.02.01a2.25 2.25 0 01.92 1.75zM8.25 10.88V7.5a2.25 2.25 0 012.25-2.25h3a2.25 2.25 0 012.25 2.25v3.38" />
  </svg>
);
...
export const AcademicCapIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path d="M12 14.25L9 12.75l-2.063.938c-.378.172-.882-.016-1.055-.393a1.5 1.5 0 010-1.114L7.94 9 6 7.5l-2.063.938a1.5 1.5 0 01-1.445-2.226L6 3.75l3-1.5 3 1.5 3.555 1.778a1.5 1.5 0 01.945 2.226L15 7.5l1.94 1.5-2.055 2.886a1.5 1.5 0 01-1.055.393L12 14.25z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 14.25l3 1.5m-3-1.5l-3 1.5m3-1.5V21m3-6.75v6.75m-6-6.75v6.75" />
    </svg>
);

export const LightBulbIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 18v-5.25m0 0a6.01 6.01 0 001.5-.189m-1.5.189a6.01 6.01 0 01-1.5-.189m3.75 7.478a12.06 12.06 0 01-4.5 0m3.75 2.311a12.06 12.06 0 00-4.5 0m4.5-2.311V18a2.25 2.25 0 002.25-2.25v-1.5a2.25 2.25 0 00-2.25-2.25v-1.5a2.25 2.25 0 00-2.25-2.25v-1.5A2.25 2.25 0 009.75 6v1.5a2.25 2.25 0 002.25 2.25v1.5a2.25 2.25 0 002.25 2.25v1.5a2.25 2.25 0 002.25 2.25z" />
    </svg>
);

export const RocketLaunchIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M15.59 14.37a6 6 0 01-5.84 7.38v-4.8m5.84-2.58a14.98 14.98 0 006.16-12.12A14.98 14.98 0 009.63 2.18a14.98 14.98 0 00-2.18 6.16m5.84 2.58v4.8m0-4.8a14.98 14.98 0 016.16-2.18m-6.16 2.18a14.98 14.98 0 01-2.18 6.16m0 0a14.98 14.98 0 01-6.16-2.18m6.16 2.18v4.8" />
    </svg>
);
